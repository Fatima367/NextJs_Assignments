...
export default function Footer() {
  return (
    <div className="w-screen bg-red-900 h-40 -ml-10 -mb-10">
      <div className="flex flex-row space-x-10 items-center justify-center text-white mt-5">
        <Link href="/">
          <p className="border-b-2 border-b-white hover:border-b-0 transition hover:cursor-pointer">
            Back to Top
          </p>
        </Link>
        <br />
      ...
      <div className="flex flex-row space-x-10 items-center justify-center text-white -mt-6">
        <h1 className="mt-8 font-bold text-2xl">Book Library</h1>
      </div>
      <br />
      <br />
